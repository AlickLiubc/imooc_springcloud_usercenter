...
public class JwtOperator {
    ...
    public static void main(String[] args) {
        ...
        String someToken = "eyJhbGciOiJIUzI1NiJ9.eyJpZCI6IjEiLCJpYXQiOjE3NTQ2MjY0NjksImV4cCI6MTc1NTgzNjA2OX0.YB_5MBbFR2vdqbXUgXQM0iwvFpzHELPSEmogvvKaYHo";
        ...
        String encodedPayload = "eyJpZCI6IjEiLCJpYXQiOjE3NTQ2MjY2MTAsImV4cCI6MTc1NTgzNjIxMH0";
        // 测试5: 解密Payload
        byte[] payload = Base64.decodeBase64(encodedPayload.getBytes());
        System.out.println(new String(payload));

        // 测试6: 这是一个被篡改的token，因此会报异常，说明JWT是安全的
        jwtOperator.validateToken("eyJhbGciOiJIUzI1NiJ9.eyJpZCI6IjEiLCJpYXQiOjE3NTQ2Mjc2NjMsImV4cCI6MTc1NTgzNzI2M30._KJacdzRd06frcEKz2E9uZcECgiNY9DL3xHV6jqZnyE");
    }
}